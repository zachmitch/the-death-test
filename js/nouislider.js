...
//////////////////////////////////////////////////////////////////////
//// Extra stuff specific to this website

var healthSlider = document.getElementById('slider-step');
...
var healthSliderValueElement = document.getElementById('slider-step-value');
...
healthSlider.noUiSlider.on('update', function( values, handle ) {
  ...
  var healthy = Math.round(Number(values[handle]));
  healthNumber = healthy;
  healthScale.value = healthNumber + 39;

  switch(healthy){
    case 1:
    case 2:
      healthy = "The end is near";
      break;
    case 3:
    case 4:
      healthy = "Not so great";
      break;
    case 5:
    case 6:
      healthy = "Meh, I'm alright"
      break;
    case 7:
    case 8:
      healthy = "Pretty, pretty good";
      break;
    case 9:
    case 10:
      healthy = "I'm in perfect health";
      break;
  }

    healthSliderValueElement.innerHTML = healthy;
});
